      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 items-start relative justify-between md:px-36 px-8 md:pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <p>
              {courseData.enrolledStudents.lenth}{" "}
              {courseData.enrolledStudents.lenth > 1 ? "students" : "student"}
            </p>
          </div>

          <p className="text-sm">
            course by{" "}
            <span className="text-blue-600 underline">AryanStack</span>
          </p>
                      ...
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          <img
                            ...
                            className="w-4 h-4 "
                          />
                          <div className="flex items-center w-full justify-between text-gray-800 text-xs md:text-default">
        ...
        {/* right column */}
        <div className="max-w-[424px] z-10 rounded-t md:rounded-none overflow-hidden shadow-[0_4px_15px_2px_rgba(0,0,0,0.1)] bg-white min-w-[300px] sm:min-w-[420px]">
          {
