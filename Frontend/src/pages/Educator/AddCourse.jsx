      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500 ">
        ...
        <div>
          {chapters.map((chapter, index) => (
            <div
              key={index}
              className="bg-white border border-white rounded-lg mb-4"
            >
          ...
          <div
            ...
            className="flex justify-center item-c  bg-blue-100 p-2 rounded-lg cursor-pointer"
          >
            + AddChapters
          </div>
          {showPopUp && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800/50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <img
                  ...
                  src={assets.cross_icon}
                  alt=""
                  className="absolute cursor-pointer top-4 right-4 w-4 "
                />
              </div>
            </div>
          )}
