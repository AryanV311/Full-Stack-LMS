  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <div className='flex items-center font-medium gap-6 mt-4'>
        <button className='bg-blue-600 px-10 py-3 rounded-md text-white cursor-pointer'>Get started</button>
        <button className='flex itemc gap-2 cursor-pointer'>learn more <img src={assets.arrow_icon} alt="arrow_icon" /></button>
      </div>
    </div>
  )
}
