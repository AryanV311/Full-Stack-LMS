...
export const TestimonialsSection = () => {
  return (
    <div className="pb-14 px-10 md:px-0">
      <h1 className="font-medium text-3xl text-gray-800">Testimonials</h1>
      ...
      <div className="grid gap-8 mt-14" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
